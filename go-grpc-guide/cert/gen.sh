...
# NOTICE: -nodes for ignore passphrase asking for development only, remove it for production to enter your password to improve the security
openssl req -newkey rsa:4096 -nodes -keyout server-key.pem -out server-req.pem -subj "/C=VN/ST=Hochiminh/L=Hochiminh/O=hwebz/OU=hdevz/CN=hdevz/emailAddress=hdevz.com@gmail.com"
