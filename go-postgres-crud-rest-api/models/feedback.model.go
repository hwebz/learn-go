...
type Feedback struct {
	...
	CreatedAt time.Time `gorm:"not null;default:'1970-01-01 00:00:01'" json:"created_at,omitempty"`
	UpdatedAt time.Time `gorm:"not null;default:'1970-01-01 00:00:01';ON UPDATE CURRENT_TIMESTAMP" json:"updated_at,omitempty"`
}
